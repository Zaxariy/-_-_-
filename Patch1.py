...
def Game(spinkoins):
    ...
    if l != 4 or random_str[0] == random_str[1] or random_str[0] == random_str[2] or random_str[0] == random_str[3] or random_str[1] == random_str[2] or random_str[1] == random_str[3] or random_str[2] == random_str[3]:
    ...
    def number(number_fuc):
        ...
        l = len(num)
        if l != 4 or num[0] == num[1] or num[0] == num[2] or num[0] == num[3] or num[1] == num[2] or num[1] == num[3] or num[2] == num[3]:
