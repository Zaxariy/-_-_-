...
def Game(spinkoins):
    ...
    if l == 4 and random_str[0] != random_str[1] and random_str[0] != random_str[2] and random_str[0] != random_str[
        3] and random_str[1] != random_str[2] and random_str[1] != random_str[3] and random_str[2] != random_str[3]:
        1
    else:
        while l != 4 or random_str[0] == random_str[1] or random_str[0] == random_str[2] or random_str[0] == random_str[
            3] or random_str[1] == random_str[2] or random_str[1] == random_str[3] or random_str[2] == random_str[3]:
    ...
    def number(number_fuc):
        ...
        l = len(num)
        if l == 4 and num[0] != num[1] and num[0] != num[2] and num[0] != num[3] and num[1] != num[2] and num[1] != num[
            3] and num[2] != num[3]:
            print(" ")
        else:
            while l != 4 or num[0] == num[1] or num[0] == num[2] or num[0] == num[3] or num[1] == num[2] or num[1] == \
                    num[3] or num[2] == num[3]:
                # print("ошибка")
                num = str(number_fuc())
                l = len(num)
...
if spinkoins>0 :
    ...
    print("Извините мы больше не можете играть")
